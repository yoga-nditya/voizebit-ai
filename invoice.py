...
# ==========================================
# ✅ Excel mengikuti template (mulai dari D)
# ==========================================
def create_invoice_xlsx(inv: dict, fname_base: str) -> str:
    ...
    _apply_outer_and_vertical_borders(ws, 10, 4, 12, 9)

    # Items table header
    ws["D14"].value = "Qty"
    ws["E14"].value = ""  # header unit kosong
    ws["F14"].value = "Date"
